...
function fixFile(filePath) {
    ...
    content = content.replace(/min-w-\[40px\]/g, 'min-w-[70px]');
    content = content.replace(/min-w-\[50px\]/g, 'min-w-[70px]');
    content = content.replace(/w-8 text-right/g, 'w-14 text-right');
    content = content.replace(/w-10 text-right/g, 'w-14 text-right');
